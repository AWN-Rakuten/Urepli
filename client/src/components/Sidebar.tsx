import { Bot, BarChart3, Workflow, Video, TrendingUp, Settings, Clapperboard, Users, BookOpen, Zap, Brain, Rocket, Smartphone } from "lucide-react";
import { Link, useLocation } from "wouter";
import { useQuery } from "@tanstack/react-query";

const navItems = [
  { id: "overview", path: "/", icon: BarChart3, label: "Overview" },
  { id: "japanese-mobile", path: "/japanese-mobile", icon: Smartphone, label: "日本モバイルApp" },

        ...
        offers: [
          {
            ...
            affiliateUrl: process.env.AFFILIATE_MNP_RAKUTEN || 'https://network.mobile.rakuten.co.jp/campaign/mnp/',
            merchant: '楽天モバイル',
            commission: 3000,
            epc: 450,
            cvr: 0.15,
          ...
          },
          {
            ...
            affiliateUrl: process.env.AFFILIATE_MNP_LINEMO || 'https://www.linemo.jp/campaign/line_point_summer/',
            merchant: 'LINEMO',
            commission: 2500,
            epc: 380,
            cvr: 0.12,
        ...
        offers: [
          {
            ...
            affiliateUrl: process.env.AFFILIATE_CREDIT_RAKUTEN || 'https://card.rakuten.co.jp/campaign/point_present/',
            merchant: '楽天カード',
            commission: 1200,
            epc: 240,
            cvr: 0.20,
          ...
          },
          {
            ...
            affiliateUrl: process.env.AFFILIATE_CREDIT_JCB || 'https://www.jcb.co.jp/ordercard/kojin_card/os_card_w.html',
            merchant: 'JCB',
            commission: 1500,
            epc: 300,
            cvr: 0.18,
        ...
        offers: [
          {
            ...
            affiliateUrl: process.env.AFFILIATE_TRAVEL_JALAN || 'https://www.jalan.net/campaign/',
            merchant: 'じゃらん',
            commission: 800,
            epc: 120,
            cvr: 0.08,
          ...
          },
          {
            ...
            affiliateUrl: process.env.AFFILIATE_TRAVEL_BOOKING || 'https://www.booking.com/deals.ja.html',
